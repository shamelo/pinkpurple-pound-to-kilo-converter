...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A beautiful pounds to kilograms converter" },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Weight Converter" },
      { property: "og:description", content: "A beautiful pounds to kilograms converter" },
